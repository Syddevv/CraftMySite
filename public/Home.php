    ...
    <header class="bg-white shadow-sm sticky top-0 z-50">
        <div class="container mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <ul class="hidden md:flex items-center gap-8 text-gray-600 font-medium">
                <li><a href="../pages/Home.html" class="hover:text-brand-primary transition">Home</a></li>
                <li><a href="../pages/About.html" class="hover:text-brand-primary transition">About</a></li>
                <li><a href="../pages/Services.html" class="hover:text-brand-primary transition">Services</a></li>
                <li><a href="../pages/Faq.html" class="hover:text-brand-primary transition">FAQ</a></li>
                <li><a href="../pages/Contact.html" class="hover:text-brand-primary transition">Contact</a></li>
            </ul>
        ...
        <nav id="mobileNav" class="hidden absolute top-full left-0 w-full bg-white border-t border-gray-100 shadow-lg md:hidden">
            <ul class="flex flex-col p-4 gap-4 font-medium">
                <li><a href="../pages/Home.html" class="block text-brand-primary">Home</a></li>
                <li><a href="../pages/About.html" class="block text-gray-600">About</a></li>
                <li><a href="../pages/Services.html" class="block text-gray-600">Services</a></li>
                <li><a href="../pages/Contact.html" class="block text-gray-600">Contact</a></li>
    ...
    <footer class="bg-gray-900 text-gray-300 py-12">
        <div class="container mx-auto px-6 grid md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="#" class="hover:text-brand-secondary transition">Home</a></li>
                    <li><a href="#" class="hover:text-brand-secondary transition">About</a></li>
                    <li><a href="#" class="hover:text-brand-secondary transition">Services</a></li>
                    <li><a href="#" class="hover:text-brand-secondary transition">Contact</a></li>
                </ul>
            </div>
            <div>
